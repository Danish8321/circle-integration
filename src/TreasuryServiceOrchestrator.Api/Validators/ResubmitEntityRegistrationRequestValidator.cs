...
namespace TreasuryServiceOrchestrator.Api.Validators;

public sealed class ResubmitEntityRegistrationRequestValidator
    : AbstractValidator<ResubmitEntityRegistrationRequest>
{
    public ResubmitEntityRegistrationRequestValidator()
    {
